...
('McLaren 720S Carbon Fiber Hood', 'Body Parts', 1501647.00, 5, 'Genuine carbon fiber replacement hood for McLaren 720S, reduces weight and enhances aerodynamics', 'mclaren-hood.png'),
('Lamborghini Aventador SVJ Brake Kit', 'Braking System', 1051152.00, 8, 'High-performance ceramic brake kit for Lamborghini Aventador SVJ with improved stopping power', 'brembo.png'),
('Ferrari Performance ECU', 'Electronics', 840921.00, 3, 'Programmable engine control unit for Ferrari models with custom mapping capabilities', 'ecu.png'),
('Bugatti Chiron Oil Filter Set', 'Engine Components', 150162.00, 15, 'Premium oil filtration system specifically designed for Bugatti Chiron W16 engine', 'thumb.png'),
('Porsche 911 GT2 RS Exhaust System', 'Exhaust', 1591746.00, 4, 'Titanium full exhaust system for Porsche 911 GT2 RS with valve control', 'exhaust.png'),
('Koenigsegg Jesko Carbon Fiber Spoiler', 'Aerodynamics', 2402637.00, 2, 'Authentic carbon fiber rear spoiler for Koenigsegg Jesko with adjustable angle', 'spoiler.png'),
('Aston Martin DBS Superleggera Wheel Set', 'Wheels', 1952142.00, 6, 'Forged aluminum wheel set for Aston Martin DBS Superleggera, 20-inch front, 21-inch rear', 'ruff-rims.png'),
('Ford GT Performance Suspension Kit', 'Suspension', 1171284.00, 7, 'Adjustable coilover suspension kit for Ford GT with track-focused setup options', 'spring.png'),
...
('Rimac Nevera Battery Management System', 'Electric Components', 1381515.00, 4, 'Advanced battery management system for Rimac Nevera electric hypercar', 'battery.png');
