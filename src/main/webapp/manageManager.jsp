                ...
                <div class="card p-4 mb-4">
                    <form action="${pageContext.request.contextPath}/managerActions"
                        ...
                        <button type="submit" name="action" value="activate"
                            ...
                            onclick="return confirmManagerAction('activate', this.form.managerEmail.value)">
                            <i class="bi bi-check-circle-fill"></i> Activate
                        </button>
                        <button type="submit" name="action" value="deactivate"
                            class="btn btn-primary action-btn"
                            onclick="return confirmManagerAction('deactivate', this.form.managerEmail.value)">
                            <i class="bi bi-exclamation-circle-fill"></i> Deactivate
                        </button>
                        <button type="submit" name="action" value="remove"
                            class="btn btn-danger action-btn"
                            onclick="return confirmManagerAction('delete', this.form.managerEmail.value)">
                        ...
                        <div class="modal-content bg-dark text-white">
                            ...
                            <div class="modal-body">
                                <form action="${pageContext.request.contextPath}/managerServlet"
                                    method="post" id="managerForm" onsubmit="return validateManagerForm()">
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        <input type="tel" class="form-control" name="phone"
                                            placeholder="Phone Number (+94XXXXXXXXX or 0XXXXXXXXX)" required>
                                    </div>
                                    <div class="mb-3">
