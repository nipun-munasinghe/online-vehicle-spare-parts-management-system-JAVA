			...
			<div class="leftsect">
				<div class="floatsect">
					<div class="profileimg">
						...
						<img src="${pageContext.request.contextPath}/images/profilepics/${u_image}" alt="Profile Picture">
					...
					<div class="rowscontainer">
						<div class="rows doublerows">
							<div class="lableinput">
								...
								<input type="text" name="fname" value="${usr.u_firstname}">
							</div>
							<div class="lableinput">
								<label for="">Last Name</label>
								<input type="text" name="lname" value="${usr. u_lastname}">
							</div>
						</div>
						<div class="rows">
							<div class="lableinput singlerow">
								<label for="">Email</label>
								<input type="text" name="mail" value="${usr.u_email}">
							</div>
						</div>
						<div class="rows doublerows">
							<div class="lableinput">
								<label for="">password</label>
								<input type="tel" name="telno" value="${usr.u_password}">
							</div>
